# ------------------------------------------------------------------------------
# ~/_plugins/asciidoctor-extensions/google-ad-block.rb
...
# ------------------------------------------------------------------------------
# A block macro that embeds a (Google Adsense) Ad (parent) block
...
Asciidoctor::Extensions.register do
  ...
  class GoogleAdsensekBlockMacro < Extensions::BlockMacroProcessor
    ...
    def process parent, target, attrs
      ...
      html = %(<div id="#{target}_parent" class="gad-parent #{attrs['role']}"></div>)
