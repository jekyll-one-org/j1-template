...
;(function($, window, document, undefined) {
    ...
    $.extend(Plugin.prototype, {
      ...
      translate: function (settings) {
        var logger						  = log4javascript.getLogger('j1deepl.translate');
        var READYSTATE_DONE		  = 4;
        var STATUS_OK       	  = 200;
        var TARGET_ELEMENT      = settings.targetElement;
        ...
        var elementType         = $(TARGET_ELEMENT).get(0).nodeName;
	        ...
	        var source_text_lines	  = this.prepareText(source_text);
					...
					var source_text     	  = $(TARGET_ELEMENT).text();
					var source_text_lines	  = this.prepareText(source_text);
				}
        ...
        if (this.settings.source_lang ==! 'auto' ) {
        	// this.xhr.send("auth_key=" + this.settings.auth_key + source_text_request + "&source_lang=" + this.settings.source_lang + "&target_lang=" + this.settings.target_lang + "&tag_handling=xml&ignore_tags=em");
					this.xhr.send("auth_key=" + this.settings.auth_key + source_text_request + "&source_lang=" + this.settings.source_lang + "&target_lang=" + this.settings.target_lang);
        } else {
        	// this.xhr.send("auth_key=" + this.settings.auth_key + source_text_request + "&target_lang=" + this.settings.target_lang + "&tag_handling=xml&ignore_tags=em");
					this.xhr.send("auth_key=" + this.settings.auth_key + source_text_request + "&target_lang=" + this.settings.target_lang);
        }
      } // END translate
