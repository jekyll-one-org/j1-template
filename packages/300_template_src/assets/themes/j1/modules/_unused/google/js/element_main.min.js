(function() {
    ...
    function Je(a) {
        ...
        return a.replace(Le, function(d, e) {
            ...
            if (f)
                return f;
            "#void" == e.charAt(0) && (e = Number("0" + e.substr(1)),
    ...
    function Ke(a) {
        return a.replace(/&([^;]+);/g, function(b, c) {
            ...
            case "quot":
                return '"';
            default:
                return "#void" != c.charAt(0) || (c = Number("0" + c.substr(1)),
...
*/
    ...
    Fr.prototype.send = function(a, b, c, d) {
        ...
        e = sd.exec(e);
        var f = e[3] || "";
        e = new od(pd,e[1] + td("?", e[2] || "", a) + td("#void", f, void 0),null);
        b = Br(e, b);
...
*/
    ...
    ou.prototype.g = function(a) {
        var b = ud(a.href);
        0 == b.indexOf("javascript:") || 0 <= b.indexOf("#void") || (this.f.push(a.href),
        this.b.push(a),
    ...
    v.ni = function(a) {
        if (this.b && this.h) {
            for (var b = 0; b < a.length; b++)
                if (a[b].target && a[b].target.className && (0 <= a[b].target.className.indexOf(bc) || 0 == a[b].target.className.indexOf("goog-")))
                    return;
    ...
    v.O = function() {
        ...
        er(this.l, C(function() {
            var f = Eg(this.l);
            var h = e;
            h = pk(ja + X(Dk(b)) + '"></head><body class="goog-te-ftab ' + X(h) + '" scroll="no" style="overflow:hidden" dir="' + X(a) + '"><a id="' + X(c) + '" href="#void" class="goog-te-ftab-link"><img src="' + X(Bk(vb)) + aa + X(Bk(Nq)) + ');background-position:-65px 0px"><span>' + ok(Z.Lf) + "</span></a></body>");
            h = hk(h);
            f.write(ke(h));
            f.close()
        }, this))
