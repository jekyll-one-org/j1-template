...
function BootstrapCookieConsent(props) {
    ...
    this.props = {
        ...
        contentURL:                 "brutze",                                   // this URL must contain the dialogs content in the needed languages
        cookieName:                 "bratze",                                   // the name of the cookie in which the configuration is stored as JSON
        ...
        get: function (name) {
            ...
            for (var i = 0; i < ca.length; i++) {
                ...
                if (c.indexOf(nameEQ) === 0) {
                    var data_encoded  = window.btoa(c);
...
//            self.modal.setAttribute("class", "modal fade");
              self.modal.setAttribute("class", "modal");
...
//      location.href = "about:home";
    ...
    // call the consent if no cookie found
    ...
    this.init = function () {
      if (Cookie.get(this.props.cookieName) === undefined && this.props.autoShowDialog) {
        Cookie.set(self.props.cookieName, user_consent_default, self.props.cookieStorageDays)
      }
