...
j1.adapter.nbinteract = (function (j1, window) {
  ...
  return {
    ...
    init: function (options) {
      ...
      settings = $.extend({}, {{notebook_options | replace: 'nil', 'null' | replace: '=>', ':' }});
    ...
    // -------------------------------------------------------------------------
    loadNbiNoteBooks: function (options) {
      var notebooks  = options.notebooks;
