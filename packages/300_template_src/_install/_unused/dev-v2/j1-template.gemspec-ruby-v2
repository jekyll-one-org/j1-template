# ------------------------------------------------------------------------------
#  J1: ~/packages/500_template_gem/j1-template.gemspec
...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{J1 Template}
  spec.description   = %q{J1 Template is a gem-based, clean, responsive and fully featured template made for Jekyll}
