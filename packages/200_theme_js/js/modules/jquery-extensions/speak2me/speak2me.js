/*
 # -----------------------------------------------------------------------------
 # ~/assets/theme/j1/modules/speak2me/js/speak2me.11.js
 # speak2me v.1.11 implementation (based on Articulate.js) for J1 Theme
 #
 # Product/Info:
 # https://jekyll.one
...
(function($) {
  ...
  // clean text for unwanted white spaces and split spoken text
  // in spans (for word-based highlighting)
