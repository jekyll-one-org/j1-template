      ...
      function processTextChunks(speaker, chunks) {
        ...
        speaker.addEventListener('start', (event) => {
          ...
          if ($currentSection !== undefined) {
            ...
            if (lastScrollPosition > 0 && $currentSection.offsetTop > lastScrollPosition) {
              window.scrollTo({
            ...
            if ($currentSection.offsetTop > speaker.lastScrollPosition) {
              speaker.lastScrollPosition = $currentSection.offsetTop;
            }
