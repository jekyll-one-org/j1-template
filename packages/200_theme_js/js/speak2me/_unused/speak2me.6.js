...
//        var lastScrollPosition      = speaker.lastScrollPosition;
          ...
          if ($('.bmd-layout-header').length) {
            ...
            lastScrollPosition      = scrollPageSeriesOffset;
          }
...
//           } // END Adjust scrolling for the Blog Posts
          ...
          if ($currentSection !== undefined) {
            ...
            //
            if ($currentSection.offsetTop > lastScrollPosition) {
              window.scrollTo({
            ...
            //
            if ($('.bmd-layout-header').length && lastScrollPosition > $currentSection.offsetTop) {
              window.scrollTo({
                top:      lastScrollPosition + ($currentSection.offsetTop),
                behavior: scrollBehavior
              });

              speaker.lastScrollPosition = lastScrollPosition + ($currentSection.offsetTop);
            }

            // set lastScroll position if pages are scrolled 'line-wise'
            //
            if (lastScrollPosition > $currentSection.offsetTop) {
