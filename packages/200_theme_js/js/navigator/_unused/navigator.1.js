      ...
      if( $getNav.hasClass('navbar-transparent') ) {
        ...
        $(window).on('scroll', function() {
          ...
          if (scrollPos > navbarHeighth) {
            ...
            $('#navigator_nav_navbar').css("background-color", navbar_scrolled_color + " !important");
//          $('.navbar-fixed').css("background-color", navbar_scrolled_color + " !important");
          } else {
            $('.navbar-fixed').removeClass('navbar-scrolled');
            $('.navbar-fixed').addClass('navbar-transparent');
            $('#navigator_nav_navbar').css("background-color", "");
//          $('.navbar-fixed').css("background-color", "");
          }
        });
      }
