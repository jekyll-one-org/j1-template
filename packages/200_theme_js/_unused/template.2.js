...
// Modules *explicitely* forced exposed for run-time to the global namespace (window)
// -----------------------------------------------------------------------------
...
const J1AdocResultViewer     = require('./js/api/asciidoctor/view_results.js'); // Additional Vanilla JS helper

// Modules (currently) NOT used
// -----------------------------------------------------------------------------
