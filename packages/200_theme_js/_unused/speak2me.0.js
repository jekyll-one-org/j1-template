      ...
      function processTextChunks(speaker, chunks) {
        ...
        speaker.addEventListener('start', (event) => {
          ...
          if (speaker.$paragraph !== undefined) {
            ...
            if (speaker.$paragraph[0].offsetTop != speaker.offsetTop) {
              window.scrollTo({
                top:      speaker.$paragraph[0].offsetTop - scrollBlockOffset,
          ...
          //     if (speaker.currentScrollPosition >= speaker.previousScrollPosition) {
          //       speaker.offsetTop = speaker.offsetTop + post_series_offset;     // $('.bmd-layout-header')[0].offsetTop
          //     }
          //     // else {
          //     //   speaker.offsetTop = speaker.previousScrollPosition + speaker.currentScrollPosition;
          //     // }
          //     window.scrollTo({
          //       top:      speaker.offsetTop,
          //       behavior: scrollBehavior
          //     });
          //   } else {
          //     if (speaker.currentScrollPosition >= speaker.previousScrollPosition) {
