// -----------------------------------------------------------------------------
// ~/packages/200_theme_js/wp_configs/webpack.develop.js
// Webpack development config (dev-server) for J1 Theme
//
// Product/Info:
// https://jekyll.one
//
...
const jekyllCssSrc =                    path.resolve(__dirname, ROOT, '../100_theme_css');
const jekyllJsSrc =                     path.resolve(__dirname, ROOT, '../200_theme_js');
const jekyllThemeSource =               path.resolve(__dirname, ROOT, '../300_theme_src');
const jekyllSiteSource =                path.resolve(__dirname, ROOT, '../400_theme_site');
const jekyllGemSrc =                    path.resolve(__dirname, ROOT, '../500_theme_gem');
const jekyllSite =                      path.resolve(__dirname, ROOT, '../400_theme_site/_site');
const jekyllSiteApps =                  path.resolve(__dirname, ROOT, '../400_theme_site/_site/apps');
