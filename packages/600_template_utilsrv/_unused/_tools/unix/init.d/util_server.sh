#!/bin/bash
# ------------------------------------------------------------------------------
# See: https://gist.githubusercontent.com/peterhost/715255/raw/33e404c39ae491201c447652c5d5085473495679/node_debian_init.sh
...
PATH=$PATH:/home/jadams/j1_quickstart/nodejs/bin/                               # modify if you need

#DAEMON_HOME=/apps/netlify-cms-github-oauth-provider/                           # home path to your server/app
#DAEMON_ARGS=/apps/netlify-cms-github-oauth-provider/index.js                   # path to your node.js server/app
DAEMON_HOME=/apps/utilsrv                                                       # home path to your server/app
#DAEMON_ARGS=${DAEMON_HOME}/server.js                                           # path to your node.js server/app
DAEMON_ARGS=/apps/utilsrv/server.js                                            # path to your node.js server/app

DESC="External NetlifyCMS OAuth provider"                                       # whatever fancy description you like

NODEUSER=jadams:jadams                                                          # USER who OWNS the daemon process (no matter whoever runs the init script)
                                                                                # user:group (if no group is specified, the primary GID for that user is used)

LOCAL_VAR_RUN=/apps/utilsrv/var/run                                            # in case the init script is run by non-root user, you need to
...
DAEMON=/home/jadams/j1_quickstart/nodejs/bin/$NAME                              # this SHOULD POINT TO where your node executable is
