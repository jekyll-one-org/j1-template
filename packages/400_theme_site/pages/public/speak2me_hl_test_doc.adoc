...
// This is sentence number, note 1: Search platforms are using complex algorithms.
// This is sentence number, note 2: Search platforms are using complex algorithms.
// This is sentence number, note 3: Search platforms are using complex algorithms.
// This is sentence number, note 4: Search platforms are using complex algorithms.
