...
// -----------------------------------------------------------------------------
include::{documentdir}/100_swiper_features.asciidoc[]

include::{documentdir}/100_swiper_html_layout.asciidoc[]
include::{documentdir}/100_swiper_initialization.asciidoc[]

include::{documentdir}/110_swiper_common_options.asciidoc[]

include::{documentdir}/200_swiper_parameters_a_k.asciidoc[]
