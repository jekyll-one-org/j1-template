...
image:
  path:                                 /assets/image/module/attic/1920x1280/vyshnavi-bisani.jpg
  width:                                1920
  height:                               1280
...
resource_options:
  - attic:
      slides:
        - url:                          /assets/image/module/attic/1920x1280/vyshnavi-bisani.jpg
          alt:                          Photo by Vyshnavi Bisani on Unsplash
          badge:
            type:                       unsplash
            author:                     Vyshnavi Bisani
            href:                       //unsplash.com/@vyshnavibisani
---
