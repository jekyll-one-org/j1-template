...
|`published`  |Set to false if you don't want a specific post to show up
...
In addition to [Managing posts], another thing you may want to do with your
Jekyll site is create static pages. By taking advantage of the way Jekyll
copies files and directories, this is easy to do.
...
get URLfor the file `other.md` by setting this at the top of the file:
`permalink: /other`
====
...
a look at this example site {github-sass-support-jekyll-example}[using Sass support in Jekyll].
