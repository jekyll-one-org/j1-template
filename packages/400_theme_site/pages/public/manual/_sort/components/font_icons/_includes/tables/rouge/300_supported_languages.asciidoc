...
|The https://coffeescript.org/[Coffeescript, {browser-window--new}]
...
|`groovy`
|groovy
|The Apache https://www.groovy-lang.org/[Groovy, {browser-window--new}]
...
|`idlang`
|idlang
|IDLang, the https://www.l3harrisgeospatial.com/Software-Technology/IDL[Interactive Data Language, {browser-window--new}]
...
or
https://pry.github.io/[Pry, {browser-window--new}]
...
|litcoffee
|The https://sukima.github.io/litcoffee-presentation/[Literate coffeescript, {browser-window--new}]
...
|`lua`
|lua
|The https://www.lua.org/[Lua, {browser-window--new}] language. Lua is a
...
|`m68k`
|m68k
|The language https://www.easy68k.com/[Motorola 68k Assembler, {browser-window--new}]
...
|`moonscript`
|moon
|the https://moonscript.org/[Moonscript, {browser-window--new}]
...
https://nginx.org/[NGINX, {browser-window--new}]. NGINX is a high performance
...
programming language (https://nim-lang.org/). Nim is a statically typed
...
|`tcl`
|tcl
|The https://tcl.tk/[Tool Command Language, {browser-window--new}].
