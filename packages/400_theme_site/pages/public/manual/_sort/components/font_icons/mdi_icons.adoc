---
title:                                  MDI Icons
title_extention:                        MDI Icons for J1 Template
tagline:                                Use Font Icons

date:                                   2022-12-08
#last_modified:                         2023-01-01

description: >
                                        Material Design Icons MDI for J1 Theme are a very
...
comments:                               false
regenerate:                             false
permalink:                              /pages/public/manuals/components/fonticons/mdi/
...
Material Design Icon repository provided by _Google_. The Icon set is a
growing collection fully integrated by the Jekyll theme usable
out-of-the-box.
...
lightbox::base-color-palette[ 1280, {lightbox-image-data--base-color-palette} ]

include::{tabledir}/mdi_icons/510_bs_color_palette.asciidoc[]

=== MD Color Palette

For _J1 Theme_, 17 additional color variations are available comply with
the concepts of _Google Material Design_:

.Material Design color palette
lightbox::md-color-palette[ 1280, {lightbox-image-data--md-color-palette} ]

==== Indigo

The color `Indigo` is used as the `primary` color for J1 Theme. You'll find
...
The color `Pink` is used as the `complementary` color for J1 Theme. You'll
