...
keywords: >
                                        ...
                                        sites, static, jamstack, bootstrap, touch,
                                        image, slider, swiper
...
compress:                               true
regenerate:                             false
permalink:                              /pages/public/manual/module/swiper/
...
Swiper provides a complete slider/carousel engine that can be operated via
touch (mobile devices) and mouse/keyboard (desktop). The following modules
are registered in the project bundle (see the end of swiper-bundle.js):
...
Slide navigation::
swiping, arrow keys, mouse wheel, buttons (swiper-button-prev/next), pagination, scrollbar

Hardware-accelerated transitions::
via CSS transforms (translate3d), including special effects such as fade, cube, flip, coverflow, creative, cards
...
Accessibility (A11y)::
history/hash navigation for deep linking Slides
...
|link:#prop-swiper-navigation-nextEl[swiper.navigation.nextEl]
|HTMLElement |HTMLElement of "next" navigation button

|link:#prop-swiper-navigation-prevEl[swiper.navigation.prevEl]
|HTMLElement |HTMLElement of "previous" navigation button

|Methods | |

|link:#method-swiper-navigation-destroy[swiper.navigation.destroy()] |
|Destroy navigation

|link:#method-swiper-navigation-init[swiper.navigation.init()] |
|Initialize navigation

|link:#method-swiper-navigation-update[swiper.navigation.update()] |
...
|link:#param-pagination-bulletActiveClass[bulletActiveClass] |string
|'swiper-pagination-bullet-active' |CSS class name of currently active
pagination bullet

|link:#param-pagination-bulletClass[bulletClass] |string
|'swiper-pagination-bullet' |CSS class name of single pagination bullet

|link:#param-pagination-bulletElement[bulletElement] |string |'span'
|Defines which HTML tag will be used to represent single pagination
bullet. Only for `bullets` pagination type.

|link:#param-pagination-clickable[clickable] |boolean |false |If
`true` then clicking on pagination button will cause transition to
appropriate slide. Only for bullets pagination type

|link:#param-pagination-clickableClass[clickableClass] |string
|'swiper-pagination-clickable' |CSS class name set to pagination when it
is clickable

|link:#param-pagination-currentClass[currentClass] |string
|'swiper-pagination-current' |CSS class name of the element with
currently active index in "fraction" pagination

|link:#param-pagination-dynamicBullets[dynamicBullets] |boolean |false
...
|link:#param-pagination-dynamicMainBullets[dynamicMainBullets] |number
|1 |The number of main bullets visible when `dynamicBullets` enabled.

|link:#param-pagination-el[el] |HTMLElement \| CSSSelector \| null |null
|String with CSS selector or HTML element of the container with
pagination

|link:#param-pagination-enabled[enabled] |boolean | |Boolean property to
use with breakpoints to enable/disable pagination on certain breakpoints

|link:#param-pagination-formatFractionCurrent[formatFractionCurrent]
|function(number) | |format fraction pagination current number. Function
receives current number, and you need to return formatted value

|link:#param-pagination-formatFractionTotal[formatFractionTotal]
|function(number) | |format fraction pagination total number. Function
receives total number, and you need to return formatted value

|link:#param-pagination-hiddenClass[hiddenClass] |string
|'swiper-pagination-hidden' |CSS class name of pagination when it
becomes inactive

|link:#param-pagination-hideOnClick[hideOnClick] |boolean |true |Toggle
(hide/show) pagination container visibility after click on Slider's
container

|link:#param-pagination-horizontalClass[horizontalClass] |string
|'swiper-pagination-horizontal' |CSS class name set to pagination in
horizontal Swiper

|link:#param-pagination-lockClass[lockClass] |string
|'swiper-pagination-lock' |CSS class name set to pagination when it is
disabled

|link:#param-pagination-modifierClass[modifierClass] |string
|'swiper-pagination-' |The beginning of the modifier CSS class name that
will be added to pagination depending on parameters

|link:#param-pagination-paginationDisabledClass[paginationDisabledClass]
|string |'swiper-pagination-disabled' |CSS class name added on swiper
container and pagination element when pagination is disabled by
breakpoint

|link:#param-pagination-progressbarFillClass[progressbarFillClass]
|string |'swiper-pagination-progressbar-fill' |CSS class name of
pagination progressbar fill element

|link:#param-pagination-progressbarOpposite[progressbarOpposite]
...
|link:#param-pagination-progressbarOppositeClass[progressbarOppositeClass]
|string |'swiper-pagination-progressbar-opposite' |CSS class name of
pagination progressbar opposite

|link:#param-pagination-renderBullet[renderBullet] |function(number,
string) |null a|
...
|link:#param-pagination-renderCustom[renderCustom] |function(Swiper,
number, number) |null a|
...
|link:#param-pagination-renderFraction[renderFraction] |function(string,
string) |null a|
...
|link:#param-pagination-renderProgressbar[renderProgressbar]
|function(string) |null a|
...
|link:#param-pagination-totalClass[totalClass] |string
|'swiper-pagination-total' |CSS class name of the element with total
number of "snaps" in "fraction" pagination

|link:#param-pagination-type[type] |'bullets' \| 'fraction' \|
'progressbar' \| 'custom' |bullets |String with type of pagination. Can
be `bullets`, `fraction`, `progressbar` or `custom`

|link:#param-pagination-verticalClass[verticalClass] |string
...
|link:#prop-swiper-pagination-bullets[swiper.pagination.bullets]
|[.text-green]#HTMLElement[]# |Array of pagination bullets HTML
elements. To get specific slide HTMLElement use
`swiper.pagination.bullets[1]`.

|link:#prop-swiper-pagination-el[swiper.pagination.el] |HTMLElement
|HTMLElement of pagination container element

|Methods | |

|link:#method-swiper-pagination-destroy[swiper.pagination.destroy()] |
|Destroy pagination

|link:#method-swiper-pagination-init[swiper.pagination.init()] |
|Initialize pagination

|link:#method-swiper-pagination-render[swiper.pagination.render()] |
|Render pagination layout

|link:#method-swiper-pagination-update[swiper.pagination.update()] |
...
|[.text-green]#T[]# |Array with slide items passed by `virtual.slides`
parameter
...
[cols="2a,3a,3a,3a", options="header", width="100%", role="table-striped table-responsive mt-4"]
|===
|Name |Type |Default |Description
