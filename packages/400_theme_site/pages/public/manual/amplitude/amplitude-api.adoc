...
description: >
                                        Amplitude is a JavaScript library to control the design of audio media elements on web pages. The concept allows designers to fully control the look and feel of audio players without deep scripting knowledge.
keywords: >
...
all. If you want to design your own player, the rest of this manual lists
every CSS class and JavaScript method Amplitude supports.
...
Bea (Wheeler) is a young British pop singer. She writes songs about real life,
feelings, and growing up. Many people like her because her music is honest, 
funny, and authentic.
