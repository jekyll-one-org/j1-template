---
title:                                  Wistia iFame API
title_extention:                        Manage WT Players
tagline:                                Manage WT Players

date:                                   2023-10-14
last_modified:                          2025-06-17

description: >
                                        Wistia offered an API (Application Programming Interface)
                                        called the Wistia Player API, which allowed developers to
                                        interact with and control Wistia videos embedded on websites
                                        or applications.
keywords: >
                                        open source, free, template, jekyll, jekyllone, web,
                                        sites, static, jamstack, bootstrap,
                                        html, html5, video, support, wistia
...
permalink:                              /pages/public/manuals/integrations/videojs/wistia_api/
  ...
  - attic:
      slides:
        - url:                          /assets/image/module/attic/1920x1280/j1-videojs-api.jpg
          alt:                          J1 Wistia iFrame API Poster
---
...
[source, html]
----
<iframe src="//fast.wistia.net/embed/iframe/e4a27b971d?
