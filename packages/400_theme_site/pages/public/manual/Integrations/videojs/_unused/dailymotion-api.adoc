...
title_extention:                        Manage DM Players
tagline:                                Manage DM Players
...
description: >
                                        ...
                                        (SDK) that allowed developers to interact with and access
                                        various features of the Dailymotion platform programmatically.
keywords: >
                                        open source, free, template, jekyll, jekyllone, web,
                                        sites, static, jamstack, bootstrap,
                                        html, html5, video, support, dailymotion

categories:                             [ Manual ]
tags:                                   [ API, Dailymotion ]
...
permalink:                              /pages/public/manuals/integrations/videojs/dailymotion_api/
  ...
  - attic:
      slides:
        - url:                          /assets/image/module/attic/1920x1280/j1-videojs-api.jpg
          alt:                          Dalymotion Player SDK Poster
---
...
The JavaScript API (SDK) `api.dmcdn.net/all.js` is available from
link://github.com/dailymotion/dailymotion-sdk-js[GitHub, {browser-window--new}]
and must be loaded from link://api.dmcdn.net/all.js[Dailymotion CDN, {browser-window--new}].
This SDK provide access to the features of the
link://developers.dailymotion.com/api#graph-api[Dailymotion Data API, {browser-window--new}].

[role="mb-4"]
[WARNING]
====
Dailymotion does not longer support using this JavasScript *SDK* (API) creating
a Player integration on webpages and should only be used for interaction with
the Data API. DM Players can be embedded with any of Dailymotion embed methods
that are decribed on the pages of
link://developers.dailymotion.com/player[DM Developers, {browser-window--new}].
====
...
Find all Player API (SDK) methods below.
...
[role="mt-5"]
[[dm-javascript-api-methods]]
=== Methods

lorem:sentences[5]

[role="mt-4"]
[[dm-api-methods-getLoginStatus]]
==== getLoginStatus()
...
[role="mt-5"]
[[dm-api-methods-logout-parameters]]
===== Parameters
...
[role="mt-5"]
[[dm-javascript-api-events-parameters]]
=== Parameters
...
[role="mt-4"]
[[dm-api-methods-event-subscribe]]
=== Event.subscribe()
...
[role="mt-5"]
[[dm-api-methods-event-subscribe-parameters]]
==== Parameters
...
[role="mt-4"]
[[dm-api-methods-eventunsubscribe]]
=== Event.unsubscribe()
...
[role="mt-5"]
[[dm-api-methods-event-unsubscribe-parameters]]
==== Parameters
...
[role="mt-4"]
[[dm-api-events-fullscreenchange]]
==== fullscreenchange
...
[role="mt-4"]
[[dm-api-events-video_start]]
==== video_start


[role="mt-4"]
[[dm-api-events-ad_play]]
==== ad_play


[role="mt-4"]
[[dm-api-events-playing]]
==== playing
...
[role="mt-4"]
[[dm-api-events-ad_pause]]
==== ad_pause


[role="mt-4"]
[[dm-api-events-video_end]]
==== video_end
...
[role="mt-4"]
[[dm-api-events-qualitiesavailable]]
==== qualitiesavailable
...
[role="mt-4"]
[[dm-api-events-subtitlesavailable]]
==== subtitlesavailable
...
[cols="3a,9a", width="100%", options="header", role="rtable mt-4 mb-8"]
|===
