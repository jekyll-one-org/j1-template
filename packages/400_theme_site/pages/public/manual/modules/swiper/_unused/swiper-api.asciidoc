...
|link:#param-a11y[a11y] |boolean \| A11yOptions | a|
...
|link:#param-breakpointsBase[breakpointsBase] |'container' \|
CSSSelector \| 'window' |window |Base for breakpoints (beta). Can be
`+window+` or `+container+`. If set to `+window+` (by default) then
breakpoint keys mean window width. If set to `+container+` then
breakpoint keys treated as swiper container width
...
|link:#param-effect[effect] |'slide' \| 'fade' \| 'cube' \| 'coverflow'
\| 'flip' \| 'creative' \| 'cards' |slide |Transition effect. Can be
...
Swiper is fully typed, it exports `+Swiper+` and `+SwiperOptions+`
types:
...
You can also check auto generated link:/types[TypeScript definitions
explorer] for all the types, options, properties and methods.

https://github.com/nolimits4web/swiper-website/edit/master/src/pages/swiper-api.mdx[Edit
this page on GitHub]

link:/[image:/images/swiper-logo.svg[Swiper]]

Swiper

Docs

link:/get-started[Getting Started]link:/swiper-api[Swiper Core /
API]link:/element[Swiper Element]link:/react[Swiper
React]link:/vue[Swiper Vue]link:/swiper-mcp[Swiper
MCP]link:/changelog[Changelog]

Resources

link:/demos[Demos]link:/plugins[Plugins]link:/playground[Playground]link:/blog[Blog]link:/sponsors[Sponsors]

Premium

link:/premium-guide[Premium Guide]https://studio.swiperjs.com[Swiper
Studio]https://uiinitiative.com[UI
Initiative]https://uiinitiative.com/catalog/carousel-slider[Carousel
Slider]https://uiinitiative.com/catalog/super-flow[Super
Flow]https://uiinitiative.com/catalog/shaders-slider[Shaders
Slider]https://uiinitiative.com/catalog/material-you-slider[Material You
Slider]

Compare

link:/compare/swiper-vs-slick[Swiper vs
Slick]link:/compare/swiper-vs-owl-carousel[Swiper vs Owl
Carousel]link:/compare/swiper-vs-flickity[Swiper vs
Flickity]link:/compare/swiper-vs-embla-carousel[Swiper vs
Embla]link:/compare/swiper-vs-splide[Swiper vs
Splide]link:/compare/swiper-vs-glidejs[Swiper vs
Glide.js]link:/compare/swiper-vs-keen-slider[Swiper vs Keen Slider]

Support

https://sponsors.nolimits4web.com[Become a
Sponsor]https://github.com/sponsors/nolimits4web[Support
Developer]link:/sponsors[Sponsors]

All product names, logos and brands are property of their respective
owners.

Copyright © 2026 Swiper by
https://nolimits4web.com[image:/images/n4w-logo.svg[nolimits4web]]

https://paneflow.com[image:/images/projects/paneflow.svg[PaneFlow -
Create Stunning Slideshows Visually. No Code
Required]]https://t0ggles.com[image:/images/projects/t0ggles.svg[t0ggles
- Your ultimate multiple projects management
tool]]https://studio.swiperjs.com[image:/images/projects/swiper-studio-logo.svg[Swiper
Studio - Create Beautiful And Responsive Sliders Without Writing Any
Code]]https://uiinitiative.com[image:/images/projects/uiinitiative.svg[UI
Initiative - Premium templates & plugins for Swiper and
Framework7]]https://startpagehq.com[image:/images/projects/startpagehq.svg[Start
Page HQ]]https://fisper.app[image:/images/projects/fisper.png[Fisper -
Local AI Voice Dictation for macOS]]
