...
<div class="container g-0 mb-5">
    <div class="row gx-1">
      ...
      <div class="col-md-9">
          <div id="swiper1" class="swiper swiper-container swiper--multi gallery-slider">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <img src="/assets/image/modules/masterslider/slider_4/ms-free-animals-1.jpg" />
                </div>
      ...
      <!-- Thumbs Slider (right) -->
      <div class="col-md-3">
          <div id="swiper2" class="swiper swiper-container swiper--multi thumbs-slider--right">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <img src="/assets/image/modules/masterslider/slider_4/ms-free-animals-1.jpg" />
                </div>
...
$(function() {
  ...
  var dependencies_met_page_ready = setInterval (() => {
    ...
    if (atticFinished) {
      ...
      // Initialize Master Swiper instance (right)
