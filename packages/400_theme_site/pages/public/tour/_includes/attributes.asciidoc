...
:data-images--themes-menu:                        "assets/image/pages/roundtrip/themes-1920x1280.jpg, Themes menu (Bootswatch)"
:data-images--styles-menu:                        "assets/image/pages/roundtrip/styles-menu-1280x800.jpg, Styles menu (Bootswatch)"

:data-quicksearch--icon:                          "assets/image/pages/roundtrip/600_quicksearch/quicksearch_icon.jpg, Search button (magnifier) in the quick access area"
:data-quicksearch--input:                         "assets/image/pages/roundtrip/600_quicksearch/quicksearch_input.jpg, Input bar for a QuickSearch"
:data-quicksearch--results:                       "assets/image/pages/roundtrip/600_quicksearch/quicksearch_results.jpg, Results for a QuickSearch"
