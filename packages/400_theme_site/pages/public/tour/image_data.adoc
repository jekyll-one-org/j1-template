...
The *default* app employed by J1 Template is *PhotoSwipe Lightbox V5*, a
powerful Javascript library free to use for private or business websites.
This lightbox is an excellent choice for web developers (rich API) and
for mobile devices, with extended touch, pan, and swipe support.

As an alternative, *Lightbox V3* can be used. This lightweight lightbox
is a good choice for websites running (mostly) on desktop computers but
also supports mobile devices, including touch, pan, and swipe. For more
complex use cases, like a thumbnail gallery preview or video support,
*LightGallery* can be used.
