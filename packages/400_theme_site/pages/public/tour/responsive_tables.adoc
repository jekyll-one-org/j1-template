...
tagline:                                View tables at its best
...
[cols="3a,3a,6a", options="header", width="100%", role="table-striped rtable mt-4"]
|===
...
[source, asciidoc, role="noclip"]
----
[cols="4a,8a", options="header", width="100%", role="table-striped rtable no-rtext"]
|===
|Variable |Description
...
[cols="4a,8a", options="header", width="100%", role="table-striped rtable no-rtext mt-4"]
|===
|Variable |Description
