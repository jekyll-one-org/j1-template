...
.BS Image Cards + Lightbox + Captions
masonry::image_cards_example[role="mb-4"]
...
----
# --------------------------------------------------------------------------
# Bootstrap Image Cards + Lightbox + Captions
#
- grid:
  enabled:                          true
...
.Image Grid + No Gutters + Captions
masonry::image_grid_base_example[role="mb-4"]
