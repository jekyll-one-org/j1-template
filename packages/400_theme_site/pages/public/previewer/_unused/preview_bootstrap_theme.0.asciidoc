    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse ml-2" id="navbarColor03">
        ...
        <form class="d-flex">
          ...
          <button class="btn btn-light btn-sm ml-3" type="submit">Search</button>
        </form>
      </div>
    </div>
  </nav>
...
[source, html]
----
<nav class="navbar navbar-expand-lg navbar-light md-light mb-3">
  <div class="container-fluid">
    <a class="link-no-decoration navbar-brand" href="javascript:void(0)">Navbar</a>
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
      data-bs-target="#navbarColor03" aria-controls="navbarColor03"
    ...
    <div class="collapse navbar-collapse ml-2" id="navbarColor03">
      ...
      <form class="d-flex">
        <input class="form-control mt-1" type="text" placeholder="Search">
        <button class="btn btn-primary btn-sm ml-3" type="submit">Search</button>
      </form>
    </div>
  </div>
</nav>
...
heading tags, ranging from `<h1>` through `<h6>`. The lower the heading level,
the higher its importance. Therefore `<h1>` tag defines the most important
heading, whereas the `<h6>` tag defines the least important heading in a
document.
...
Popovers and Tooltips rely on the 3rd party library _Popper.js_ for
positioning. To make them properly positioned, the Javascript library
`popper.min.js` has to be included *before* `bootstrap.js` in order to make
popovers and tooltips to work.
