...
description: >
                                        ...
                                        supported by J1 Theme.

keywords: >
                                        previewer, preview, overview, tool,
                                        sizes, rotate, flip, pulse, spin, color,
                                        sorted, category, people, nature, objects,
                                        places, symbols, markup, picker,
                                        twitter, emoji,
                                        ...
                                        twitter, emoji, picker, preview, previewer
...
resources:                              [ animate, comments, clipboard, rouge, twemoji, twemoji_picker ]
resource_options:
  - attic:
      slides:
...
J1 Theme comes with the Twitter Emoji library (Twemoji) V1 included and
