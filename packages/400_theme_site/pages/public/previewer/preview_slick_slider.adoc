...
[role="mb-4"]
J1 Post sliders pull content from a specific category. All Carousels for posts
display the post category, the post title, the author and date. All Slick
sliders for the J1 Theme can be easily customized in various ways, such as
changing the number of posts displayed, the slider speed, or the navigation
options.
