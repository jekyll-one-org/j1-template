...
++++
<div class="carousel-title"> <i class="mdib mdib-view-carousel mdib-24px mr-2"></i> Base Silder · Pagination </div>
...
<div class="swiper-container mb-5">
  ...
  <div class="swiper-wrapper">
    ...
    <li class="swiper-slide">
      <img src="/assets/image/module/swiper/simple/free_animal/image/free-animal-1.jpg" alt="Slide Image free-animal-1">
    </li>          
    <li class="swiper-slide">
      <img src="/assets/image/module/swiper/simple/free_animal/image/free-animal-2.jpg" alt="Slide Image free-animal-2">
    </li>          
    <li class="swiper-slide">
      <img src="/assets/image/module/swiper/simple/free_animal/image/free-animal-3.jpg" alt="Slide Image free-animal-3">
    </li>          
    <li class="swiper-slide">
      <img src="/assets/image/module/swiper/simple/free_animal/image/free-animal-4.jpg" alt="Slide Image free-animal-4">
    </li>          
    <li class="swiper-slide">
      <img src="/assets/image/module/swiper/simple/free_animal/image/free-animal-5.jpg" alt="Slide Image free-animal-5">
    </li>          
    <li class="swiper-slide">
      <img src="/assets/image/module/swiper/simple/free_animal/image/free-animal-6.jpg" alt="Slide Image free-animal-6">
    </li>          
  </div> <!-- END Swiper Wrapper (slides) -->

  <div class="swiper-pagination" style="margin-top: .75rem;"></div>  
</div>

<!-- Add Pagination OUTSIDE -->
    ...
    var atticFinished = (j1.adapter.attic.getState() == 'finished') ? true : false;
      ...
      if (atticFinished) {
        ...
        const mySwiper = new Swiper('.swiper-container', {
          ...
          // event settings
          on: {
            // Swiper's default pagination will automatically handle the active class.
            // If you need more customization, you can implement it here.            
            slideChange: (swiper) => { 
