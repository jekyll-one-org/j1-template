...
++++
<div class="carousel-title"> <i class="mdib mdib-view-carousel mdib-24px mr-2 mb-3"></i> Extendend Swiper · Layout Stacked</div>
<div id="app">
  <!-- Posters slider -->
  <div id="stacked_slider" class="posters-slider">
    <div class="swiper">
...
@media (orientation: portrait) {
  .posters-slider {
    ...
    --posters-slider-height: calc(68vw * .8);
  }
}
