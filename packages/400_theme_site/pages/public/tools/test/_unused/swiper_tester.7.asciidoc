...
.Extended Slider · Thums View
swiper::thumb_slider_animals[role="mt-0 mb-5"]

// ++++
// <!-- Master Slider -->
// <div class="carousel-title"> <i class="mdib mdib-view-carousel mdib-24px mr-2"></i> Thumbs View · Position Bottom </div>
// <div id="thumb_slider_animals">
...
$(function() {
  ...
  var dependencies_met_page_ready = setInterval (() => {
    ...
    var xhrLoadState_success  = (j1.xhrDOMState['#thumb_slider_animals_parent'] === 'success') ? true : false;

    if (atticFinished && xhrLoadState_success) {

      // common params for all sliders
      //
       const commonParams = {
        main_slider_id:         '#thumb_slider_animals',                        // should ALWAYS an id (NOT a class)
        slideHeight:             'auto',                                        // 'auto' | int
        thumbs: {
          placement:            'top',                                          // placement [top | bottom]
        }
      };
