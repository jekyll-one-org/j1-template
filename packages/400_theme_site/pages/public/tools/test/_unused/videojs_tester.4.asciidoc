  ...
  var dependencies_met_vjs_player_exist = setInterval(function(options) {
    ...
    if (vjsPlayerExist) {
      ...
      videojs("2rtQOsWaAXc").ready(function() {
        ...
        // Stellt sicher, dass die Controlbar "flex" ist, um die Positionierung zu ermöglichen
        // vjsPlayer.controlBar.el().style.display = 'flex';
        // vjsPlayer.controlBar.el().style.alignItems = 'center';
