...
all ads instantly. No pre-roll, mid-roll, or overlay ads. 100% Free
alternative to YouTube Premium for watching videos undisturbed.

[role="mt-4"]
== Video selection

Paste a YT video link to the input element below.
