...
description: >
                                        J1 Theme supports Masonry, a JavaScript grid layout library.
                                        Masonry places elements in an optimal position based on available
                                        vertical space, like mason fitting stones in a wall.
...
resources:                              [ clipboard, comments, masonry, rouge ]
resource_options:
  - attic:
      padding_top:                      550
      slides:
...
<div class="content mt-5 mb-5">
  <div id="example_masonry" class="row">
    ...
    <div class="col-sm-6 col-lg-4 mb-4">
      <div class="card">
        <img class="img-fluid img-object--cover g-height-300" src="/assets/images/modules/attics/1920x1280/j1-starter-mockup-1.jpg" alt="J1 Theme" style="filter: grayscale(0) contrast(1) brightness(1);">
        <div class="card-body">
    ...
    <div class="col-sm-6 col-lg-4 mb-4">
      <div class="card">
        <img class="img-fluid img-object--cover" src="/assets/images/modules/attics/1920x1280/melanie-deziel.jpg" alt="Columbia River" style="filter: grayscale(0) contrast(1) brightness(1);">
    ...
    <div class="col-sm-6 col-lg-4 mb-4">
      ...
      <img class="img-fluid img-object--cover g-height-250" src="/assets/images/modules/attics/1920x1280/hayden-mills-2.jpg" alt="Welcome to J1" style="filter: grayscale(0) contrast(1) brightness(1);">
      	...
      	<div class="card-footer r-text-200">
      	  ...
      	  <a class="card-link text-lowercase" href="javascript:void(0)">
