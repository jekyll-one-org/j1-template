---
title:                                  Colors
title_extention:                        Color palette used by J1 Template
...
description: >
                                        The color palette used by J1 Template is based on the definitions
                                        of Google's Material Design. The color scheme comprises primary
                                        and accent colors that can be used for illustration or to develop
                                        individual brand colors of a website, designed to work harmoniously
                                        with each other.
keywords: >
