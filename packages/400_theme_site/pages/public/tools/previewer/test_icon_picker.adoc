...
// slim_select_options.wrapper_id:  {{ slim_select_options.wrapper_id | debug }}
...
// {% for select in slim_select_options.selects %}{% if select.id == page.select_id %}
// wrapper_id: {{select.wrapper_id}}
// {% endif %}{% endfor %}
