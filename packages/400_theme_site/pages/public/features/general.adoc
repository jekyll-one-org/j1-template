...
description: >
                                        ...
                                        are open source and free to use. No license issues using JekyllOne
...
in their latest versions. All of them are open source and free to use.
...
All software-platforms are open source, free to use and available on all
