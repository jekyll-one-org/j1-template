...
|`commit -am "New version 2023.3.9"`
|Commit a specific *version*.
|
[source, sh]
----
git commit -am "New version 2023.3.9"
----

|`commit --allow-empty -m "New version 2023.3.9"`
|Commit a specific version but *no* (file) changes applied.
|
[source, sh]
----
git commit --allow-empty -m "New version 2023.3.9"
----

|`commit -am "Prepare new version 2023.3.9"`
|Commit a specific version but changes are *not* final.
|
[source, sh]
----
git commit -am "Prepare new version 2023.3.9"
----
...
[source, sh]
----
git tag -a v2023.3.9 -m "v2023.3.9"
git push origin --tags
----
...
git commit --allow-empty -m "New version 2023.3.9"
git commit -am "Prepare new version 2023.3.9"
git commit -am "Latest files of version 2023.3.9"
----
