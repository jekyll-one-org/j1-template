...
|`commit -am "New version 2023.3.10"`
|Commit a specific *version*.
|
[source, sh]
----
git commit -am "New version 2023.3.10"
----

|`commit --allow-empty -m "New version 2023.3.10"`
|Commit a specific version but *no* (file) changes applied.
|
[source, sh]
----
git commit --allow-empty -m "New version 2023.3.10"
----

|`commit -am "Prepare new version 2023.3.10"`
|Commit a specific version but changes are *not* final.
|
[source, sh]
----
git commit -am "Prepare new version 2023.3.10"
----
...
[source, sh]
----
git tag -a v2023.3.10 -m "v2023.3.10"
git push origin --tags
----
...
git commit --allow-empty -m "New version 2023.3.10"
git commit -am "Prepare new version 2023.3.10"
git commit -am "Latest files of version 2023.3.10"
----
