...
"subl" for Sublime Text). On *Windows*, set the *path* to your preferred
editor like 'C:/Program Files (x86)/Notepad++/notepad++.exe'.
|
[source, sh]
----
...
|`config --system --edit`
|Opens the Git *application* configuration file (`~/Git/etc/gitconfig`)
in the default text editor, allowing you to *manually* edit the settings.
|
[source, sh]
----
