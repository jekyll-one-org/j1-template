...
description: >
                                        ...
                                        Lightbox2, Master Slider, lightGallery, or Justifie dGallery
...
.Masonry Grid of Image Cards + Lightbox
masonry::card_example[role="mt-4 mb-4"]
...
so-called justified views. Justified Gallery uses a so-called masonry grid
