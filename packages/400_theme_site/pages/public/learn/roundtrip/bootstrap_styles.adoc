...
description: >
                                        ...
                                        themes and templates. Bootstrap styles for the J1 Theme are based on the
                                        free and open-source CSS front-end framework Bootstrap of version V5.
                                        The Bootstrap styles feature for J1 Theme enables the presentation of
...
permalink:                              /pages/public/learn/roundtrip/styles/
regenerate:                             true
...
websites, offers various unique functionalities compared to other Jekyll
themes and templates. Bootstrap styles for the J1 Theme are based on the
free and open-source CSS front-end framework of version V5. The Bootstrap
styles feature for J1 Theme enables the presentation of different versions
of the same site using already prepared Bootstrap CSS templates.
...
// -----------------------------------------------------------------------------
include::{documentdir}/styles_bootstrap.asciidoc[]
