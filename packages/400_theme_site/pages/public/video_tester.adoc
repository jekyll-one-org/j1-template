---
title:                                  Video Tester
title_extention:                        Test Video Integrations
tagline:                                Test Video Integration
...
resources:                              [ gallery, lightgallery, master-slider, videojs ]
resource_options:
  - attic:
      slides:
...
$(function() {
  ...
  tech.src    = "/assets/theme/j1/modules/amplitudejs/js/plugins/tech/youtube.js";
