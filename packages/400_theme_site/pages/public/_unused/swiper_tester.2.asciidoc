...
++++
  ...
  <div id="base_image_slider_1" class="swiper swiper-container base-image-slider-1">
    ...
    <div class="swiper-wrapper" style="margin-bottom: 3.75rem; height: 400px;">
      <div class="swiper-slide">
        <a href="/assets/image/module/carousel/cats/cat-1.jpg" data-size="1024x768">
          <img src="/assets/image/module/carousel/cats/cat-1.jpg" alt="Image 1">
        </a>
      </div>
      <div class="swiper-slide">
        <a href="/assets/image/module/carousel/cats/cat-2.jpg" data-size="1024x768">
          <img src="/assets/image/module/carousel/cats/cat-2.jpg" alt="Image 2">
        </a>
      </div>
      <div class="swiper-slide">
        <a href="/assets/image/module/carousel/cats/cat-3.jpg" data-size="1024x768">
          <img src="/assets/image/module/carousel/cats/cat-3.jpg" alt="Image 3">
        </a>
      </div>
      <div class="swiper-slide">
        <a href="/assets/image/module/carousel/cats/cat-4.jpg" data-size="1024x768">
          <img src="/assets/image/module/carousel/cats/cat-4.jpg" alt="Image 4">
        </a>
      </div>
