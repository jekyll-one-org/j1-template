...
<div class="input-wrapper mt-4">
  <div class="input-container">
    ...
    <input type="text" id="videoUrl" placeholder="https://www.youtube.com/xxxx.. or xxxx..">
  </div>
...
<div id="videoContainer" class="video-container">
  ...
  <div id="emptyPlayerOverlay" class="empty-player-overlay">
    <div class="empty-player-content">
      <!--img src="img/skipcut-favicon.png" alt="Logo" width="32" height="32" -->
      <h3 class="notoc">Paste YouTube link above to watch video ad-free</h3>
      <!-- div class="features-inline">
        <span><i class="fas fa-ad"></i> No Ads</span>
        <span><i class="fas fa-fast-forward"></i> Skip Sponsors</span>
        <span><i class="fas fa-play"></i> Background Play</span>
      </div -->
    </div>
  </div>
