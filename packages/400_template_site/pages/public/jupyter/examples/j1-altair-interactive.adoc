---
title:                                  J1 NBI
tagline:                                create widgets using altair
...
permalink:                              /pages/public/jupyter/textbooks/j1-altair-interactive/
regenerate:                             false
...
//     var el = document.getElementsByClassName('vega-bind-name')[0].children[0].children[1];
