...
:binder-app-launch--j1_odes_in_python:            https://mybinder.org/v2/gh/jekyll-one/nbinteract-notebooks/main?urlpath=/tree/notebooks/j1/j1_odes_in_python.ipynb
...
image:https://mybinder.org/badge_logo.svg[Binder, link="{binder-app-launch--j1_odes_in_python}", {browser-window--new}]
endif::[]
