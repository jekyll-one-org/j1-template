...
permalink:                              /pages/public/jupyter/examples/static/j1-bokeh-tut-02/
regenerate:                             false
...
:binder-app-launch--notebook:           https://mybinder.org/v2/gh/jekyll-one/j1-binder-repo/main?filepath=notebooks/j1-bokeh-tut/bokeh_tut_01_basic_plotting.ipynb
