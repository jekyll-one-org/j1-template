...
++++
<!-- link rel="stylesheet" type="text/css" href="/assets/themes/j1/modules/nbInteract/css/core/core.css" -->

<!-- Loads nbinteract package -->
<!-- script src="https://unpkg.com/nbinteract-core" async></script -->

<!-- Load the LOCAL nbinteract package -->
<!-- script src="/assets/themes/j1/modules/nbInteract/js/core/index.bundle.js"></script -->
