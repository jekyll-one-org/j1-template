...
++++
<!-- Dropdown trigger -->
<a class="dropdowns btn btn-info mt-3 mb-4" href="#" data-target="my-dropdown">Dropdown MyFlags</a>
...
<ul id="my-dropdown" class="dropdown-content">
  <li><a href="#"><i class="flag-icon flag-icon-de rectangle size-2x"></i>Germany</a></li>
  <li class="divider" tabindex="-1"></li>
  <li><a href="#"><i class="flag-icon flag-icon-be rectangle size-2x"></i>Belgium</a></li>
  <li><a href="#"><i class="flag-icon flag-icon-dk rectangle size-2x"></i>Denmark</a></li>
  <li><a href="#"><i class="flag-icon flag-icon-es rectangle size-2x"></i>Spain</a></li>
</ul>
++++
