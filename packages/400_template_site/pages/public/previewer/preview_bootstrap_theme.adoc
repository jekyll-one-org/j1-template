...
:containers:                            true
:containers_jumbotron:                  false
:containers_list:                       true
:containers_list_groups:                false
:cards:                                 true
:cards_simple:                          true
:cards_image:                           false
:dialogs:                               true
...
++++
  <!-- Prepend H1 tag here -->
  <div id="theme" class="row g-0 mb-3">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="d-flex">
          <input class="form-control bg-body mt-1 me-5" type="search" placeholder="Search" aria-label="Search">
...
ifeval::[{containers_jumbotron} == true]
=== Jumbotron
...
ifeval::[{containers_list_groups} == true]
==== List groups
...
//     }
//
//     $(':regex(href,$navbars)').click(function(e) {
