...
<div class="mt-3">
    ...
    <div class="form-group bmd-form-group mb-2">
      ...
      <select id="language-scope" class="form-control" is="ms-dropdown" style="min-width: 20rem;">
    ...
    <div class="form-group bmd-form-group mb-2">
      <select id="destination-language" class="form-control scrollable-menu" name="destination-language" is="ms-dropdown" style="min-width: 20rem;">
      <option selected value="auto" data-image-css="fas fa-magic mt-1 mr-3 mb-1">Auto detection</option>
      <option value="CZ" data-image-css="flag-icon flag-icon-cz rectangle size-md"> Czech</option>
      <option value="DA" data-image-css="flag-icon flag-icon-dk rectangle size-md"> Danish</option>
      <option value="DE" data-image-css="flag-icon flag-icon-de rectangle size-md"> German</option>
    ...
    <!-- test element to create msDropdowns dynamically from JSON -->
    <div id="dropdowsJSON" class="mb-3" style="display:none"></div>
...
/* workaround: limit the height of the resulting list (UL) of the 'dd' select   */
.ms-dd .ms-options {
  max-height: 12rem;
}
</style>
...
<script>
  $(function() {
    ...
    //       _this.languageList = data.bumms;                                        // data.googleLanguages;
    //       makeDd(_this.languageList);
    //     },
    ...
    //
    //   el = document.getElementById("dropdowsJSON")
    //   document.getElementById("dropdowsJSON").innerHTML = "";
    //
    //   MsDropdown.make("#dropdowsJSON", {
    //     byJson: {
    //       data: data,
    //       selectedIndex: 0,
    //       name: "dropdowsJSON",
    ...
    var dependencies_met_page_ready = setInterval (function (options) {
      if ( j1.getState() === 'finished' ) {
        ...
        // readJSON('/assets/data/ms_select.json');

        // stop scrolling if ANY of the DD select is open (attr display: block)
