...
every mobile has a camera - not that bad! Presenting a bunch of (digital)
pictures is done very easily by using Justified Gallery, for example.
Videos created by a digicam or a mobile can be played by J1 Template using
the HTML5 Video support. Present videos you have made at it's best.
