...
link:{asciidoctor-extensions-lab}[Asciidoctor Extensions Lab, {browser-window--new}].
If you simply want to use the extensions from this repository, go ahead to
link:{asciidoctor-extensions-use-extension}[Using an extension, {browser-window--new}].

To create Asciidoc extensions on your own, it is highly recommended to read the
link:{asciidoctor-user-manual-extensions}[extensions section, {browser-window--new}] in
