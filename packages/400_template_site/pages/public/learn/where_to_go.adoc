...
:url-j1-experimental--where-to-go:      /pages/public/jupyter/experimental/where-to-go/
...
Experimental::
In section *Experimental*, you'll find a tour of extended but experimental
features of J1. Currently, in *Experimental*, Python's Jupyter Notebooks
for *Data Science* and *Data Analysis* are discussed. Data Science is
fundamental for all projects related to all *Digitization* concepts of the
21st century. If you're interested, what tools are available with Python to
discuss (your) *Data Analysis* projects go for this section.
