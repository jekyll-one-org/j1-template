...
{% comment %}
 # -----------------------------------------------------------------------------
 # ~/assets/theme/j1/adapter/js/videoPlayer.js (9)
...
j1.adapter.videoPlayer = ((j1, window) => {
  ...
  return {
    ...
    initPlayerUiEvents: () => {
      ...
      // -------------------------------------------------------
      var togglePlaylistBtn  = document.getElementById("toggle_playlist");
    ...
    closePlaylist: (toggleBtn, toggleSpan, toggleImg) => {
      ...
      var btn  = toggleBtn  || document.getElementById("toggle_playlist");
