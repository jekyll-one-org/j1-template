...
{% comment %}
 # -----------------------------------------------------------------------------
 # ~/assets/theme/j1/adapter/js/custom_functions.js (1)
...
/*
 # -----------------------------------------------------------------------------
 # ~/assets/theme/j1/adapter/js/customFunctions.js (1)
    ...
    init: (options) => {
      ...
      dependenciesTimeout = setTimeout(function () {
        if (dependencies_met_j1_finished) {
          clearInterval(dependencies_met_j1_finished);
          logger.warn('customFunctions init aborted: j1-finished condition not met within 5s');
        }
      }, 5000);
    }, // END init
