...
var timeSeconds;
  ...
  return {
    ...
    init: (options) => {
      ...
      // const pluginManager = new lazyCssLoader.pluginManager();
      var lazyLoader = j1LazyLoader.init({
//      cssPlugin:     '/assets/theme/j1/modules/lazyCssLoader/js/plugins/pluginA.js',
        cssPlugin:     'pluginA.js',
      });

      // Plugin dynamisch laden
      // await pluginManager.loadPlugin('./plugins/pluginA.js');
      // await lazyCssLoaderMain.pluginManager.loadPlugin('/assets/theme/j1/modules/lazyCssLoader/js/plugins/pluginA.js');
