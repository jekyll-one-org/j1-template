...
{% comment %}
 # -----------------------------------------------------------------------------
 # ~/assets/theme/j1/adapter/js/translator.js (2)
  ...
  return {
    ...
    init: function (options) {
      ...
      var dependencies_met_page_ready = setInterval (() => {
        ...
        if (j1CoreFinished && pageVisible) {
          ...
          // with fallback to the user_translate cookie.
          // -------------------------------------------------------------------
          $(document).on('shown.bs.modal', function () {
            ...
            var syncPoll = setInterval(function () {
              ...
              if (dropdownEl && dropdownEl.msDropdown) {
                ...
                // claude - translator follow language #2
                // fallback: user_translate cookie
                if (!activeLang) {
                  var currentTranslate = j1.readCookie(cookie_names.user_translate);
    ...
    cbGoogle: function (option) {
      ...
      if (srcLang == selectedTranslationLanguage ) {
        ...
        // claude - translator follow language #2
        // reset translation language in user cookie to content language
        user_translate = j1.readCookie(cookie_names.user_translate);
        ...
        logger.info('reset translation language in cookie to: ' + srcLang);
      ...
      // claude - translator follow language #2
      // save selected translation language to user cookie for dropdown
      ...
      logger.info('saved translation language to cookie: ' + selectedTranslationLanguage);
