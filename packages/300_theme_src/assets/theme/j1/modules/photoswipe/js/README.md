The `js/` folder contains a transpiled version of PhotoSwipe in
universal module definition format (umd) to be used in the browser.
...
<html>
  ...
  <body>
    ...
    <script src="../js/photoswipe-core.min.js"></script>
    <script src="../js/photoswipe-lightbox.min.js"></script>
