/*
 # -----------------------------------------------------------------------------
 # ~/assets/theme/j1/modules/aiAgent/js/aiAgent.js (9)
    ...
    function getSettings() {
     ...
     // claude - add userPrompt #1: expose userPrompt from adapter config
      ...
      return {
        ...
        storageMaxTokenSize:  adapterOpts.storageMaxTokenSize   || 120000,
        kbDelivery:           adapterOpts.kbDelivery            || 'localstorage'
      };
    }
    ...
    async function loadSettings() {
      try {
        ...
        getSettings._cache = {
          ...
          storageMaxTokenSize:  adapterOpts.storage.maxTokenSize  || 120000,
          kbDelivery:           adapterOpts.storage.delivery      || 'localstorage'
        };
      } catch { /* use defaults */ }
      updateStatusBar();
    }
