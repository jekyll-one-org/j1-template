...
"use strict";
  ...
  // [A-Za-z0-9_-] within the first 11 characters of the path. They are
  // APPENDED to the pattern list (matched LAST) to keep the resolution
  // order of the Amplitude plugin fix no. 5 unchanged.
  // ---------------------------------------------------------------------------
  //
