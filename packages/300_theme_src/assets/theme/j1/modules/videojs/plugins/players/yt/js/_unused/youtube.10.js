...
(function (root, factory) {
  ...
  const MODULE_NAME     = 'videoJS.plugin.youtube';
        ...
        if (this._pipRetryCount <= 3 && this.activeVideoId) {
          this.setTimeout(() => {
            if (this.ytPlayer && typeof this.ytPlayer.loadVideoById === 'function') {
              j1.consoleLog(isDev, 'DEBUG', CONSOLE_LOG_ID, MODULE_NAME, `retrying video load after error 153 (attempt ${this._pipRetryCount})`);
          ...
          j1.consoleLog(isDev, 'DEBUG', CONSOLE_LOG_ID, MODULE_NAME, `YT error 153: max retry attempts reached`);
