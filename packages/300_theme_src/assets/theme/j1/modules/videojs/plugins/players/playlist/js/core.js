/*
 # -----------------------------------------------------------------------------
 # ~/modules/videojs/js/plugins/players/playlist/js/core.js
 # Provides Native Core Playlist Plugin for Video.js V8 and newer
 # version 4.3.1
 #
 # Product/Info:
 ...
 #
 # videojs-playlist is licensed under the Apache-2.0 License.
 # For details, see: https://github.com/videojs/videojs-playlist/blob/main/LICENSE
