/*
 # -----------------------------------------------------------------------------
 # ~/assets/theme/j1/modules/videojs/js/dailymotion/dailymotion.js
 ...
 'use strict';
  ...
  var dependencies_met_page_ready = setInterval (() => {
    ...
    if (j1CoreFinished && pageVisible) {
      ...
      loadScript('/assets/theme/j1/modules/videojs/js/plugins/dm/api/dailymotion.sdk.min.js', apiLoaded);
      injectCss();
