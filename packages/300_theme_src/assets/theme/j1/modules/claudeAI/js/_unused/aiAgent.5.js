/*
 # -----------------------------------------------------------------------------
 # ~/assets/theme/j1/modules/claudeAi/js/claudeAi.js (5)
...
(function (root, factory) {
  ...
  class claudeAiHandler {
    ...
    // module-global adapterOptions so that AgentChat, AgentUI, and any
    ...
    try {
      ...
      if (resp.ok) {
        ...
        if (Array.isArray(fallback) && fallback.length > 0) {
          ...
          await saveAll();
          consoleLog('INFO', MODULE_NAME, `[KB] Loaded ${entries.length} entries from fallback: ${FALLBACK_JSON}`);
        }
      }
    } catch (err) {
...
const AgentUI = (() => {
  ...
  function getSettings() {
    ...
    return {
      ...
      userPrompt:       adapterOpts.userPrompt      || ''
    };
  }
