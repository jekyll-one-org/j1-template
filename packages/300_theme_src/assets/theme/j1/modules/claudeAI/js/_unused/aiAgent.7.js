/*
 # -----------------------------------------------------------------------------
 # ~/assets/theme/j1/modules/claudeAi/js/claudeAi.js (7)
 # Provides JS Core for J1 Module claudeAi (claude)
 #
 # Product/Info:
 # https://jekyll.one
 #
    ...
    function getSettings() {
     ...
     // claude - add userPrompt #1: expose userPrompt from adapter config
      return {
        ...
        storageFallback:      adapterOpts.storageFallback       || '/assets/data/apps/claudeAi/knowledgebase.json',
    ...
    async function loadSettings() {
      try {
        ...
        getSettings._cache = {
          ...
          storageFallback:      adapterOpts.storage.fallback      || '/assets/data/apps/claudeAi/knowledgebase.json',
