/*
 # -----------------------------------------------------------------------------
 # ~/assets/themes/j1/modules/videojs/js/vimeo/api/player.min.js
 # Vimeo Player API (original version)
 #
 #  Product/Info:
 #  https://jekyll.one
 ...
 #
 #  Vimeo Player is licensed under MIT License.
 #  See: https://github.com/vimeo/player.js/blob/master/LICENSE.md
