/* speak2me.js (1.1.0). (C) 2017 Adam Coti. MIT @license: en.wikipedia.org/wiki/MIT_License
...
;(function($) {
    ...
    var methods = {
        speak : function(options) {
            ...
            if (isChrome) {
              setInterval(function () {
                  ...
                  console.debug("pause-resumed");
              }, 10000);
            }

            function processDOMelements(clone) {
                var copy, prepend;
                // Remove tags from the "ignoreTags" array because the user called "speak2me('recognize')"
                ...
                // Remove DOM objects as specified in the HTML with "data-speak2me-ignore".
                jQuery(clone).find("[data-speak2me-ignore]").addBack("[data-speak2me-ignore]").each(function() {
                    jQuery(this).html("");
                });
                // Search for prepend data as specified in the HTML with "data-speak2me-prepend".
                ...
                // Search for append data as specified in the HTML with "data-speak2me-append".
                ...
                // Search for DOM object to be replaced as specified in the HTML with "data-speak2me-swap".
                ...
                // Search for DOM object to spelled out as specified in the HTML with "data-speak2me-spell".
            ...
            function cleanDOMelements(final) {
                ...
                // Search for <speak2me> in comments, copy the text, place it outside the comment,
                ...
                // Replace a string of characters with another as specified by "speak2me('replace')".
        ...
        // All the functions for speak2me.js.
        pause : function() {
            window.speechSynthesis.pause();
            return this;
        },
