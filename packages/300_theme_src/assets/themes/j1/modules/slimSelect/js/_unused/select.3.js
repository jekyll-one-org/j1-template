 ...
 (function (global, factory) {
     ...
     class Option {
         constructor(option) {
             ...
             this.deletable = option.disabled !== undefined ? option.deletable : false;
     ...
     class SlimSelect {
         constructor(config) {
             ...
             const renderCallbacks = {
                 ...
                 deleteItem: this.events.deleteItem,
             };
         ...
         setData(data) {
             ...
             //   var deleteButton = document.getElementById(data[i].cb);
             ...
             data.forEach((el) => {
               var deleteButton = document.getElementById(el.cb);
                 if (deleteButton !== undefined) {
                   deleteButton.addEventListener('click', (event) => {
                     // suppress default actions|bubble up
                     event.preventDefault();
