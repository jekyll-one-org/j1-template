            ...
            $.getJSON('{{jf_gallery_options.xhr_data_path}}', function (data) {
              ...
              for (var i in data['{{item.gallery.id}}']) {
                ...
                if (captions_lightbox != null && lightbox == 'lg') {
                  content +=  '<span class="speak2me-ignore"> <a ';
                  content +=  'href="' +img+ '">' + '\n';
            ...
            $.getJSON('{{jf_gallery_options.xhr_data_path}}', function (data) {
              ...
              for (var i in data['{{item.gallery.id}}']) {
                ...
                if (captions_lightbox != null && lightbox == 'lg') {
                  ...
                  //
                  content +=  '<span class="speak2me-ignore"><a data-sub-html="' +captions_lightbox+ '" ';
              ...
              for (var i in data['{{item.gallery.id}}']) {
                ...
                hidden_video_div += '<div style="display:none; speak2me-ignore;" id="' +video_id+ '">' + '\n';
