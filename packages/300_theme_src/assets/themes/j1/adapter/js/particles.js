...
var logText;
  ...
  function executeParticles(particleID, particle_data) {

    {% assign particle_default = particles_defaults.particle_data %}

    {% for item in particles_settings.particles %}
      {% if item.particle.enabled %}

        {% assign particle_id               = item.particle.id %}
        {% assign particle_item             = item.particle.particle_data %}
        {% assign item_particles            = item.particle.particle_data.particles %}
...
//      var itemParticlesJSON;
        ...
        // particlesJS(particleID, particlesOptionsOBJECT);
        // particlesJS(particleID, particlesOptionsJSON);
