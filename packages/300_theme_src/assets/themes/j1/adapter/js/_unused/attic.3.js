        ...
        {% if item.attic.enabled %}
          ...
          function {{attic_id}} (atticOptions) {
           ...
           $(window).on('backstretch.before', function (e, instance, index) {
              ...
              var idx                 = index;
              // var atticOptions        = _this.atticOptions;
              // var textOverlayTitle    = instance.images[index].textOverlay.title
              // var textOverlayTagline  = instance.images[index].textOverlay.tagline;
              // var textOverlayHTML;
            ...
            $(window).on('backstretch.after', function (e, instance, index) {
              var textOverlayTitle    = instance.images[index].textOverlay.title
              var textOverlayTagline  = instance.images[index].textOverlay.tagline;
              var caption             = instance.images[index].caption;
              var badge               = instance.images[index].badge;
