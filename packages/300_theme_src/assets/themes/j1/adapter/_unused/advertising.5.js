...
//        gasDiv.id = ad.id;
          ...
          var myDiv = document.getElementById(ad.id);
...
//        var textnode   = '<ins class="adsbygoogle"></ins>';
//        var textnode   = 'data-ad-client=' + ad.publisherID;
//        var textnode   = 'data-ad-client=' + ad.publisherID;
          var textnode   = document.createTextNode('data-ad-client=' + ad.publisherID);
          ...
          document.getElementById(ad.id).appendChild(node);


//        content = document.createTextNode('<ins>');
