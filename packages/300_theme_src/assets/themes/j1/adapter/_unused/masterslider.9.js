...
{% assign sliders                    = master_slider_settings.sliders %}
...
j1.adapter.masterslider = (function (j1, window) {
  ...
  return {
    ...
    init: function (options) {
      ...
      // collect slider data
      sliderOptions = $.extend({}, {{master_slider_options | replace: 'nil', 'null' | replace: '=>', ':' }});
      sliders       = $.extend({}, {{master_slider_options.sliders | replace: 'nil', 'null' | replace: '=>', ':' }});
