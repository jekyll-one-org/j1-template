...
-------------------------------------------------------------------------------- {% endcomment %}
{% assign chat_defaults   = modules.defaults.chat.defaults %}
{% assign chat_settings   = modules.chat.settings %}
...
//      if ( j1.getState() === 'finished' && pageVisible ) {
        if (j1.getState() == 'finished' && pageVisible && atticFinished) {
          ...
          {% if chat_enabled %}
            ...
            // [INFO   ] [j1.adapter.chat                    ] [ detected chat provider (j1_config): {{chat_provider}}} ]
            // [INFO   ] [j1.adapter.chat                    ] [ start processing load region head, layout: {{page.layout}} ]
            {% case chat_provider %}
            {% when "webwhiz" %}
            ...
            -------------------------------------------------------------------- {% endcomment %}
            {% when "vivochat" %}
            // [INFO   ] [j1.adapter.chat                    ] [ place provider: VivoChat ]
            ...
            -------------------------------------------------------------------- {% endcomment %}
            {% when "tutgpt" %}
            // [INFO   ] [j1.adapter.chat                    ] [ place provider: TutGPT ]
            ...
            -------------------------------------------------------------------- {% endcomment %}
            {% when "chatbob" %}
            // [INFO   ] [j1.adapter.chat                    ] [ place provider: ChatBob ]
