    ...
    init: function (options) {
      ...
      var dependencies_met_user_state_available = setInterval (function () {
        ...
        if (user_state_detected) {
         ...
         // if (!styleLoaded) {
         //   logger.warn('\n' + 'theme CSS not loaded: ' + user_state.theme_css);
         // }
...
//        window.location.href = error_page;
      ...
      var dependencies_met_theme_ready = setInterval (function () {
        user_state  = j1.readCookie(cookie_names.user_state);
        styleLoaded = styleSheetLoaded(user_state.theme_css);
        ...
        if (styleLoaded) {
          ...
          logger.debug('\n' + 'state: ' + _this.getState());
          logger.info('\n' + 'module initialized successfully');
          clearInterval(dependencies_met_theme_ready);
        }

      }, 25); // END dependencies_met_theme_ready
