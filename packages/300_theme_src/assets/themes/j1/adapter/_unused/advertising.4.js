...
//    var gad_containers = document.querySelectorAll('.gad-container');
...
//        gasDiv.id = ad.id;
          ...
          textNode += '<ins class="adsbygoogle"';
          textNode += '   data-ad-client=' + ad.publisherID;
          textNode += '>';
...
//        ins = document.getElementsByTagName('ins');
//        var ins_id = 'ins_' + ad.id;
//        ins = document.getElementById(ad.id).innerText;
//        ins = $('#' + ad.id);
//        var ins_id = 'ins_' + ad.id;
//        content.setAttribute('id', ins_id);
//        content.setAttribute('data-ad-client', ad.publisherID);

//        var ins_id = 'ins_' + ad.id;
//        content.setAttribute('id', ins_id);

          // content.setAttribute('data-ad-test', ad.test);

          // var d = document.getElementById('ins_id');
          // d.className += 'adsbygoogle';
          // d.setAttribute('data-ad-test', ad.test);

          // content.setAttribute('data-ad-client', ad.publisherID);
          // content.setAttribute('data-ad-slot', ad.slot);
          // content.setAttribute('data-ad-format', ad.format);
          // content.setAttribute('data-full-width-responsive', ad.responsive);
