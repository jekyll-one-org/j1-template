      ...
      var dependencies_met_page_ready = setInterval (function (options) {
        ...
        if (j1.getState() === 'finished' && pageVisible) {
          ...
          if (ttsDisabled) {
            ...
            var speak2meModalDialog = document.createElement('dialog');
            speak2meModalDialog.id = 'speak2me-dialog';
            document.body.append(speak2meModalDialog);
            ...
            speak2meModalDialog.append(speak2meModal);
