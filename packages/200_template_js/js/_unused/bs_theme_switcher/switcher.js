/*
 # -----------------------------------------------------------------------------
 #  ~/bs_theme_switcher/js/switcher.js
 #  Bootstrap Theme Switcher v1.1.5 implementation for J1 template
 #
 #  Product/Info:
 #  https://jekyll.one
 ...
 #  Bootstrap Theme Switcher is licensed under MIT License.
  ...
  BootstrapThemeSwitcher.prototype = {
    ...
    addThemesToControl: function() {
      ...
      if (this.$element.is('ul')) {
        ...
        // jadams: suppress senseless warning
