...
//    } else if ( $getWindow > breakPoint || $getWindow <= 1024 && $windowOrientation == 'portrait'  ) {
      ...
      // -----------------------------------------------------------------------
        ...
        // $('.dropdown.navitem > li').on('mouseenter', function(){
          var $container  = $(this);
          ...
          if ( $list.length == 1 ) {
            ...
            // if ($list.hasClass('scrollable-menu') && $list.css('display') == 'block') {
            if ($list.hasClass('scrollable-menu')) {
              ...
              timeoutHandle = window.setTimeout(function () {
                if ($list.hasClass('open')){
                    // alert("opend"); // opend
                    var logText = 'scrollable-menu: opened';
                    logger.info(logText);
                  if ($('body').hasClass('mm-ocd-opened')){
                    return false;
                  } else {
        ...
        $('.dropdown-menu > li').hover(function() {
          ...
          if ( $list.length == 1 ) {
            ...
            if ( typeof $list.css('max-height') !== 'undefined' && $list.css('max-height') !== 'none') {
