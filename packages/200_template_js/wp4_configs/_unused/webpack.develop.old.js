...
const devServerPort =                     process.env.WP_JEKYLL_PORT || 4444;
const contentNotFromWebpack =             path.join(__dirname, ROOT, '../400_template_site/_site');
...
module.exports = merge(common, {
  ...
  devServer: {
    ...
    watchOptions:                         {
                                            ignored: [
                                              /node_modules/                    // NOTE: do not watch for changes on node modules

                                            ],
                                            aggregateTimeout: 300,
                                            poll:            1000
                                          },
    contentBase:                          contentNotFromWebpack,                // NOTE: serve Jekyll Site
