...
window.j1.core.cookie_consent           = require('./js/cookie_consent/cookie_consent.js');
window.j1.core.navigator                = require('./js/navigator/navigator.js');
window.j1.core.webhooks                 = require('./js/webhooks/octokit/client.js');
window.j1.core.ssm                      = require('./js/sticky-side-menu/ssm.js');
...
// window.bs_tour                          = require('./js/bs_tour/bootstrap-tour.js');
