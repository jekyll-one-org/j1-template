...
plugin "ytp" is loaded and configured correcly. But if the page "audioPlayer.adoc"
is reloaded (e.g. by the browser), the plugin "ytp" is loaded but NOT configured
and end with (the log):

```
[22:23:40.527] [t54mumc4u69] [INFO ] [j1.adapter.amplitude.tech] [ytp.js:889] 
Initialize plugin|tech (ytp) : started
[http://localhost:41000/assets/theme/j1/modules/amplitudejs/js/tech/ytp.js:889]
```

For the page "audio_data.adoc" this behavious is never seen.
Why is it?
