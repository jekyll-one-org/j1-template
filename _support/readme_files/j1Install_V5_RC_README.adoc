...
2. Install J1 Theme USERIZED (recommended)
  ...
  Install J1 from remote
	...
	gem install j1-template --version 2024.3.6 --no-document --user-install
...
4. Generate a J1 Project
	...
	cd c:\j1-projects && j1 generate starter-2024.3.6


5. Setup and Run a J1 Project

	cd c:\j1-projects\starter-2024.3.6 && j1 setup && j1 site
