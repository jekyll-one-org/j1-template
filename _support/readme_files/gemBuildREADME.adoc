...
publish (RubyGems):                   gem push j1-template-2022.5.2.gem
unpublish (RubyGems):                 gem yank j1-template -v 2022.5.2
...
uninstall (version):                  gem uninstall j1-template -v 2022.5.2
uninstall (version/forced):           gem uninstall j1-template -v 2022.5.2 --force
uninstall (version/user/forced):      gem uninstall j1-template -v 2022.5.2 --user --force
...
mklink /D "C:\Temp\starter" "C:\Temp\starter 2022.5.2"
