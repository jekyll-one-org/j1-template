...
publish (RubyGems):                   gem push j1-template-2021.3.0.gem
unpublish (RubyGems):                 gem yank j1-template -v 2021.3.0
...
uninstall (version):                  gem uninstall j1-template -v 2021.3.0
uninstall (version/forced):           gem uninstall j1-template -v 2021.3.0 --force
uninstall (version/user/forced):      gem uninstall j1-template -v 2021.3.0 --user --force
...
# git tag -a v2021.3.0 -m "v2021.3.0"
...
mklink /D "C:\Temp\starter" "C:\Temp\starter 2021.3.0"
