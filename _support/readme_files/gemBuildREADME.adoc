...
publish (RubyGems):                   gem push j1-template-2021.2.6.gem
unpublish (RubyGems):                 gem yank j1-template -v 2021.2.6
...
uninstall (version):                  gem uninstall j1-template -v 2021.2.6
uninstall (version/forced):           gem uninstall j1-template -v 2021.2.6 --force
uninstall (version/user/forced):      gem uninstall j1-template -v 2021.2.6 --user --force
...
mklink /D "C:\Temp\starter" "C:\Temp\starter 2021.2.6"
