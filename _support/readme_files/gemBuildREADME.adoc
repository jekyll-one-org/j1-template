...
unpublish (RubyGems):                 gem yank j1-template -v2026.1.1
...
uninstall (version):                  gem uninstall j1-template -v2026.1.1
uninstall (version/forced):           gem uninstall j1-template -v2026.1.1 --force
uninstall (version/user/forced):      gem uninstall j1-template -v2026.1.1 --user --force
