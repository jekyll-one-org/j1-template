...
publish (RubyGems):                   gem push j1-template-2021.2.7.gem
unpublish (RubyGems):                 gem yank j1-template -v 2021.2.7
...
uninstall (version):                  gem uninstall j1-template -v 2021.2.7
uninstall (version/forced):           gem uninstall j1-template -v 2021.2.7 --force
uninstall (version/user/forced):      gem uninstall j1-template -v 2021.2.7 --user --force
...
# git tag -a v2021.2.7 -m "v2021.2.7"
...
mklink /D "C:\Temp\starter" "C:\Temp\starter 2021.2.7"
