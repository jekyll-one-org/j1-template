...
publish (RubyGems):                   gem push j1-template-2023.5.1.gem
unpublish (RubyGems):                 gem yank j1-template -v 2023.5.1
...
uninstall (version):                  gem uninstall j1-template -v 2023.5.1
uninstall (version/forced):           gem uninstall j1-template -v 2023.5.1 --force
uninstall (version/user/forced):      gem uninstall j1-template -v 2023.5.1 --user --force
...
mklink /D "C:\Temp\starter" "C:\Temp\starter 2023.5.1"
