...
publish (RubyGems):                   gem push j1-template-2021.1.27.gem
unpublish (RubyGems):                 gem yank j1-template -v 2021.1.27
...
uninstall (version):                  gem uninstall j1-template -v 2021.1.27
uninstall (version/forced):           gem uninstall j1-template -v 2021.1.27 --force
uninstall (version/user/forced):      gem uninstall j1-template -v 2021.1.27 --user --force
...
# git tag -a v2021.1.27 -m "v2021.1.27"
...
mklink /D "C:\Temp\starter" "C:\Temp\starter 2021.1.27"
