...
publish (RubyGems):                   gem push j1-template-2026.0.18.gem
unpublish (RubyGems):                 gem yank j1-template -v2026.0.18
...
uninstall (version):                  gem uninstall j1-template -v2026.0.18
uninstall (version/forced):           gem uninstall j1-template -v2026.0.18 --force
uninstall (version/user/forced):      gem uninstall j1-template -v2026.0.18 --user --force
...
mklink /D "C:\Temp\starter" "C:\Temp\starter2026.0.18"
