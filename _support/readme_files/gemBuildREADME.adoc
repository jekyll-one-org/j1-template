...
publish (RubyGems):                   gem push j1-template-2023.3.5.gem
unpublish (RubyGems):                 gem yank j1-template -v 2023.3.5
...
uninstall (version):                  gem uninstall j1-template -v 2023.3.5
uninstall (version/forced):           gem uninstall j1-template -v 2023.3.5 --force
uninstall (version/user/forced):      gem uninstall j1-template -v 2023.3.5 --user --force
...
mklink /D "C:\Temp\starter" "C:\Temp\starter 2023.3.5"
