...
publish (RubyGems):                   gem push j1-template-2026.1.3.gem
unpublish (RubyGems):                 gem yank j1-template -v2026.1.2
...
uninstall (version):                  gem uninstall j1-template -v2026.1.2
uninstall (version/forced):           gem uninstall j1-template -v2026.1.2 --force
uninstall (version/user/forced):      gem uninstall j1-template -v2026.1.2 --user --force
