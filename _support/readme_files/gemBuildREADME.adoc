...
publish (RubyGems):                   gem push j1-template-2024.3.11.gem
unpublish (RubyGems):                 gem yank j1-template -v 2024.3.11
...
uninstall (version):                  gem uninstall j1-template -v 2024.3.11
uninstall (version/forced):           gem uninstall j1-template -v 2024.3.11 --force
uninstall (version/user/forced):      gem uninstall j1-template -v 2024.3.11 --user --force
...
mklink /D "C:\Temp\starter" "C:\Temp\starter 2024.3.11"
