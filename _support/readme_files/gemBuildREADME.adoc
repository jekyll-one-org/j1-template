...
publish (RubyGems):                   gem push j1-template-2021.1.4.gem
unpublish (RubyGems):                 gem yank j1-template -v 2021.1.4
...
uninstall (version):                  gem uninstall j1-template -v 2021.1.4
uninstall (version/forced):           gem uninstall j1-template -v 2021.1.4 --force
uninstall (version/user/forced):      gem uninstall j1-template -v 2021.1.4 --user --force
...
# git tag -a v2021.1.4 -m "v2021.1.4"
...
mklink /D "C:\Temp\starter" "C:\Temp\starter 2021.1.4"
