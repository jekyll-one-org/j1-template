...
publish (RubyGems):                   gem push j1-template-2026.0.2.gem
unpublish (RubyGems):                 gem yank j1-template -v 2026.0.2
...
uninstall (version):                  gem uninstall j1-template -v 2026.0.2
uninstall (version/forced):           gem uninstall j1-template -v 2026.0.2 --force
uninstall (version/user/forced):      gem uninstall j1-template -v 2026.0.2 --user --force
...
mklink /D "C:\Temp\starter" "C:\Temp\starter 2026.0.2"
