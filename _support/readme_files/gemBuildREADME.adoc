...
publish (RubyGems):                   gem push j1-template-2022.5.1.rc1.gem
unpublish (RubyGems):                 gem yank j1-template -v 2022.5.1.rc1
...
uninstall (version):                  gem uninstall j1-template -v 2022.5.1.rc1
uninstall (version/forced):           gem uninstall j1-template -v 2022.5.1.rc1 --force
uninstall (version/user/forced):      gem uninstall j1-template -v 2022.5.1.rc1 --user --force
