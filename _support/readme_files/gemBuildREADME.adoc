...
publish (RubyGems):                   gem push j1-template-2021.3.2.gem
unpublish (RubyGems):                 gem yank j1-template -v 2021.3.2
...
uninstall (version):                  gem uninstall j1-template -v 2021.3.2
uninstall (version/forced):           gem uninstall j1-template -v 2021.3.2 --force
uninstall (version/user/forced):      gem uninstall j1-template -v 2021.3.2 --user --force
...
# git tag -a v2021.3.2 -m "v2021.3.2"
...
mklink /D "C:\Temp\starter" "C:\Temp\starter 2021.3.2"
