...
publish (RubyGems):                   gem push j1-template-2021.1.23.gem
unpublish (RubyGems):                 gem yank j1-template -v 2021.1.23
...
uninstall (version):                  gem uninstall j1-template -v 2021.1.23
uninstall (version/forced):           gem uninstall j1-template -v 2021.1.23 --force
uninstall (version/user/forced):      gem uninstall j1-template -v 2021.1.23 --user --force
...
# git tag -a v2021.1.23 -m "v2021.1.23"
...
mklink /D "C:\Temp\starter" "C:\Temp\starter 2021.1.23"
