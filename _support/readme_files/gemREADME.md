...
``` sh
  gem install j1-template -v 2023.7.4 --user-install --no-document
```
...
``` sh
  gem install j1-template -v 2023.7.4 --source 'https://gem.fury.io/jekyll-one-org/' --user-install --no-document
```
