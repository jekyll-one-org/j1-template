...
``` sh
  gem install j1-template -v 2023.6.17 --user-install --no-document
```
...
``` sh
  gem install j1-template -v 2023.6.17 --source 'https://gem.fury.io/jekyll-one-org/' --user-install --no-document
```
