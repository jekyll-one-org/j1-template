...
``` sh
  gem install j1-template -v2026.0.12 --user-install --no-document
```

You can also use version comparators like >= or ~>

``` sh
  gem install j1-template -v "~>2026.0.12" --user-install --no-document
```

### Install a Gem from different source

``` sh
  gem install j1-template -v2026.0.12 --source 'https://gem.fury.io/jekyll-one-org/' --user-install --no-document
```
...
gem install j1-template-2026.0.12.gem --no-document
--
Using rubygems directory: C:/Users/w11/.gem/ruby/3.2.0
...
Successfully installed j1-template-2026.0.12
4 gems installed



gem install --install-dir C:/Users/w11/.gem/ruby/3.2.0 --no-document j1-template-2026.0.12.gem

gem install --user-install --no-document j1-template-2026.0.12.gem
