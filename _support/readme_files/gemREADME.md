...
``` sh
  gem install j1-template -v 2024.2.0 --user-install --no-document
```
...
``` sh
  gem install j1-template -v 2024.2.0 --source 'https://gem.fury.io/jekyll-one-org/' --user-install --no-document
```
