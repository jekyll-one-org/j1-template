...
``` sh
  gem install j1-template -v 2026.0.5 --user-install --no-document
```
...
``` sh
  gem install j1-template -v 2026.0.5 --source 'https://gem.fury.io/jekyll-one-org/' --user-install --no-document
```
...
gem install j1-template-2026.0.5.gem --no-document
--
Using rubygems directory: C:/Users/w11/.gem/ruby/3.2.0
...
Successfully installed j1-template-2026.0.5
4 gems installed



gem install --install-dir C:/Users/w11/.gem/ruby/3.2.0 --no-document j1-template-2026.0.5.gem

gem install --user-install --no-document j1-template-2026.0.5.gem
