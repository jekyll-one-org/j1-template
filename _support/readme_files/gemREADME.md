...
``` sh
  gem install j1-template -v 2023.3.7 --user-install --no-document
```
...
``` sh
  gem install j1-template -v 2023.3.7 --source 'https://gem.fury.io/jekyll-one-org/' --user-install --no-document
```
