...
``` sh
  gem install j1-template -v 2023.6.9 --user-install --no-document
```
...
``` sh
  gem install j1-template -v 2023.6.9 --source 'https://gem.fury.io/jekyll-one-org/' --user-install --no-document
```
