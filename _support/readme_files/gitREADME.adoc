...
then push the new tag
  ...
  git tag -a v2026.0.7 -m "v2026.0.7"
...
Then:
  ...
  git commit -am "New version2026.0.7"
  git commit --allow-empty -m "New version2026.0.7"
  git commit -am "Prepare new version2026.0.7"
  git commit -am "Latest files of version2026.0.7"
