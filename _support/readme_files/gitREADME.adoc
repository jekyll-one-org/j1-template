...
then push the new tag
  ...
  git tag -a v2026.0.8 -m "v2026.0.8"
...
Then:
  ...
  git commit -am "New version2026.0.8"
  git commit --allow-empty -m "New version2026.0.8"
  git commit -am "Prepare new version2026.0.8"
  git commit -am "Latest files of version2026.0.8"
