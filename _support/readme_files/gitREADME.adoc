...
=== From local
  ...
  git tag -d v2023.6.13

=== From remote

  git push -d origin v2023.6.13
...
then push the new tag
  ...
  git tag -a v2023.6.13 -m "v2023.6.13"
...
Then:
  ...
  git commit -am "New version 2023.6.13"
  git commit --allow-empty -m "New version 2023.6.13"
  git commit -am "Prepare new version 2023.6.13"
  git commit -am "Latest files of version 2023.6.13"
