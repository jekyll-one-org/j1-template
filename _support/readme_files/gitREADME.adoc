...
Then:
  ...
  git commit -am "New version 2024.3.22"
  git commit --allow-empty -m "New version 2024.3.22"
  git commit -am "Prepare new version 2024.3.22"
  git commit -am "Latest files of version 2024.3.22"
