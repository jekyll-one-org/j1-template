...
then push the new tag
  ...
  git tag -a v2026.1.2 -m "v2026.1.2"
...
Then:
  ...
  git commit -am "New version v2026.1.2"
  git commit --allow-empty -m "New version v2026.1.2"
  git commit -am "Prepare new version v2026.1.2"
  git commit -am "Latest files of version v2026.1.2"
