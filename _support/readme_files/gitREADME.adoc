...
then push the new tag
  ...
  git tag -a v2024.3.3 -m "v2024.3.3"
...
Then:
  ...
  git commit -am "New version 2024.3.3"
  git commit --allow-empty -m "New version 2024.3.3"
  git commit -am "Prepare new version 2024.3.3"
  git commit -am "Latest files of version 2024.3.3"
