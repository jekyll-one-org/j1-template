...
=== From local
  ...
  git tag -d v2024.3.20

=== From remote

  git push -d origin v2024.3.20
...
then push the new tag
  ...
  git tag -a v2024.3.20 -m "v2024.3.20"
...
Then:
  ...
  git commit -am "New version 2024.3.20"
  git commit --allow-empty -m "New version 2024.3.20"
  git commit -am "Prepare new version 2024.3.20"
  git commit -am "Latest files of version 2024.3.20"
