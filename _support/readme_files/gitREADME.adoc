...
#
  git tag -a v2022.5.3 -m "v2022.5.3"
...
Then:
  ...
  git commit -am "New version 2022.5.3"
  git commit -am "Prepare new version 2022.5.3"
  git commit -am "Latest files of version 2022.5.3"
