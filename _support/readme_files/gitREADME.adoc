...
=== From local
  ...
  git tag -d v2026.0.13

=== From remote

  git push -d origin v2026.0.13
...
then push the new tag
  ...
  git tag -a v2026.0.13 -m "v2026.0.13"
...
Then:
  ...
  git commit -am "New version2026.0.13"
  git commit --allow-empty -m "New version2026.0.13"
  git commit -am "Prepare new version2026.0.13"
  git commit -am "Latest files of version2026.0.13"
