...
== From local
  ...
  git tag -d v2022.5.0.rc2

=== From remote

git push -d origin v2022.5.0.rc2
...
#
  git tag -a v2022.5.0.rc2 -m "v2022.5.0.rc2"
...
Then:
  ...
  git commit -am "New version 2022.5.0.rc2"
  git commit -am "Prepare new version 2022.5.0.rc2"
  git commit -am "Latest files of version 2022.5.0.rc2"
