...
== From local
  ...
  git tag -d v2022.0.12

=== From remote

git push -d origin v2022.0.12
...
Then:
  ...
  git commit -am "New version 2022.0.12"
  git commit -am "Prepare new version 2022.0.12"
  git commit -am "Latest files of version 2022.0.12"
