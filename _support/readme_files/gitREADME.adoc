...
Then:
  ...
  git commit -am "New version 2023.1.3"
  git commit --allow-empty -m "New version 2023.1.3"
  git commit -am "Prepare new version 2023.1.3"
  git commit -am "Latest files of version 2023.1.3"
