...
then push the new tag
  ...
  git tag -a v2026.0.5 -m "v2026.0.5"
...
Then:
  ...
  git commit -am "New version 2026.0.5"
  git commit --allow-empty -m "New version 2026.0.5"
  git commit -am "Prepare new version 2026.0.5"
  git commit -am "Latest files of version 2026.0.5"
