...
then push the new tag
  ...
  git tag -a v2023.5.0 -m "v2023.5.0"
...
Then:
  ...
  git commit -am "New version 2023.5.0"
  git commit --allow-empty -m "New version 2023.5.0"
  git commit -am "Prepare new version 2023.5.0"
  git commit -am "Latest files of version 2023.5.0"
