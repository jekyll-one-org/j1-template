...
== From local
  ...
  git tag -d v2022.0.10

=== From remote

git push -d origin v2022.0.10
...
Then:
  ...
  git commit -am "New version 2022.0.10"
  git commit -am "Prepare new version 2022.0.10"
  git commit -am "Latest files of version 2022.0.10"
