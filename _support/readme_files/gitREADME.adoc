...
#
# git tag -a v2022.4.4 -m "v2022.4.4"
...
Then:
  ...
  git commit -am "New version 2022.4.4"
  git commit -am "Prepare new version 2022.4.4"
  git commit -am "Latest files of version 2022.4.4"
