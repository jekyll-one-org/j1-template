...
#
  git tag -a v2022.5.0 -m "v2022.5.0"
...
Then:
  ...
  git commit -am "New version 2022.5.0"
  git commit -am "Prepare new version 2022.5.0"
  git commit -am "Latest files of version 2022.5.0"
