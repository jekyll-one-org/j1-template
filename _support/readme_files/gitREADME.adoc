...
=== From local
  ...
  git tag -d v2023.0.18

=== From remote

  git push -d origin v2023.0.18
...
#
  git tag -a v2023.0.18 -m "v2023.0.18"
...
Then:
  ...
  git commit -am "New version 2023.0.18"
  git commit --allow-empty -m "New version 2023.0.18"
  git commit -am "Prepare new version 2023.0.18"
  git commit -am "Latest files of version 2023.0.18"
