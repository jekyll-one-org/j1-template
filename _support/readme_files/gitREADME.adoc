...
== From local
  ...
  git tag -d v2022.5.1.rc0

=== From remote

git push -d origin v2022.5.1.rc0
...
#
  git tag -a v2022.5.1.rc0 -m "v2022.5.1.rc1"
...
Then:
  ...
  git commit -am "New version 2022.5.1.rc1"
  git commit -am "Prepare new version 2022.5.1.rc1"
  git commit -am "Latest files of version 2022.5.1.rc1"
