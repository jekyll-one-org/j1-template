...
then push the new tag
  ...
  git tag -a v2023.4.4 -m "v2023.4.4"
...
Then:
  ...
  git commit -am "New version 2023.4.4"
  git commit --allow-empty -m "New version 2023.4.4"
  git commit -am "Prepare new version 2023.4.4"
  git commit -am "Latest files of version 2023.4.4"
