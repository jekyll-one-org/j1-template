...
#
  git tag -a v2022.6.2 -m "v2022.6.2"
...
Then:
  ...
  git commit -am "New version 2022.6.2"
  git commit --allow-empty -m "New version 2022.6.2"
  git commit -am "Prepare new version 2022.6.2"
  git commit -am "Latest files of version 2022.6.2"
