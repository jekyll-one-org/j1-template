...
Then:
  ...
  git commit -am "New version 2026.0.0"
  git commit --allow-empty -m "New version 2026.0.0"
  git commit -am "Prepare new version 2026.0.0"
  git commit -am "Latest files of version 2026.0.0"
