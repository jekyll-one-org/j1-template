...
then push the new tag
  ...
  git tag -a v2023.6.6 -m "v2023.6.6"
...
Then:
  ...
  git commit -am "New version 2023.6.6"
  git commit --allow-empty -m "New version 2023.6.6"
  git commit -am "Prepare new version 2023.6.6"
  git commit -am "Latest files of version 2023.6.6"
