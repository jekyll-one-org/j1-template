...
=== From local
  ...
  git tag -d v2023.10.2

=== From remote

  git push -d origin v2023.10.2
...
then push the new tag
  ...
  git tag -a v2023.10.2 -m "v2023.10.2"
...
Then:
  ...
  git commit -am "New version 2023.10.2"
  git commit --allow-empty -m "New version 2023.10.2"
  git commit -am "Prepare new version 2023.10.2"
  git commit -am "Latest files of version 2023.10.2"
