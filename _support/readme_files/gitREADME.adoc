...
then push the new tag
  ...
  git tag -a v2026.0.6 -m "v2026.0.6"
...
Then:
  ...
  git commit -am "New version2026.0.6"
  git commit --allow-empty -m "New version2026.0.6"
  git commit -am "Prepare new version2026.0.6"
  git commit -am "Latest files of version2026.0.6"
