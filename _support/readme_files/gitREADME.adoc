...
=== From local
  ...
  git tag -d v2023.0.17

=== From remote

  git push -d origin v2023.0.17
...
#
  git tag -a v2023.0.17 -m "v2023.0.17"
...
Then:
  ...
  git commit -am "New version 2023.0.17"
  git commit --allow-empty -m "New version 2023.0.17"
  git commit -am "Prepare new version 2023.0.17"
  git commit -am "Latest files of version 2023.0.17"
