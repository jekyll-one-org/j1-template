...
Then:
  ...
  git commit -am "New version 2023.6.9"
  git commit --allow-empty -m "New version 2023.6.9"
  git commit -am "Prepare new version 2023.6.9"
  git commit -am "Latest files of version 2023.6.9"
