...
at [J1 Publish](https://publish.jekyll.one/)
...
css: > css@2021.1.0 clean D:\j1\github\j1-template\packages\100_template_css
css: > run-p -s clean:*
js: > js@2021.1.0 clean D:\j1\github\j1-template\packages\200_template_js
js: > run-p -s clean:*
css: $ npm run build_css && npm run uglify_css
css: > css@2021.1.0 build_css D:\j1\github\j1-template\packages\100_template_css
css: > run-p -s theme_css:*
js: > js@2021.1.0 lint D:\j1\github\j1-template\packages\200_template_js
js: > run-p -s lint:*
...
..
js: $ npm run build-js
js: > js@2021.1.0 build-js D:\j1\github\j1-template\packages\200_template_js
js: > cross-var webpack --mode production --config $npm_package_wp_build
js: > js@2021.1.0 uglify-js D:\j1\github\j1-template\packages\200_template_js
js: > terser dist/template.js -o dist/template.min.js -m
css: > css@2021.1.0 deploy D:\j1\github\j1-template\packages\100_template_css
css: > run-p -s mkdir:* && run-p -s deploy:*
js: > js@2021.1.0 deploy D:\j1\github\j1-template\packages\200_template_js
js: > run-s -s deploy:*
..
css: Rendering Complete, saving .css file...
css: Wrote CSS to D:\j1\github\j1-template\packages\100_template_css\dist\themes\uno-light\bootstrap.css
css: > css@2021.1.0 uglify_css D:\j1\github\j1-template\packages\100_template_css
css: > run-p -s uglify_css:*
..
site: > site@2021.1.0 bundle D:\j1\github\j1-template\packages\400_template_site
