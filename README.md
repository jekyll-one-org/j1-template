...
css: > css@2024.2.2 clean path_to_\j1-template\packages\100_theme_css
css: > run-p -s clean:*
js: > js@2024.2.2 clean path_to_\j1-template\packages\200_theme_js
js: > run-p -s clean:*
site: > site@2024.2.2 bundle path_to_\j1-template\packages\400_theme_site
site: > run-s -s bundler:*
css: $ npm run build_css && npm run uglify_css
site: Create bundle ..
css: > css@2024.2.2 build_css path_to_\j1-template\packages\100_theme_css
css: > run-p -s theme_css:*
js: > js@2024.2.2 lint path_to_\j1-template\packages\200_theme_js
js: > run-p -s lint:*
...
js: > js@2024.2.2 build-js path_to_\j1-template\packages\200_theme_js
js: > cross-var webpack --mode production --config $npm_package_wp_build
site: Bundle Rubies using user path ..
css: > css@2024.2.2 uglify_css path_to_\j1-template\packages\100_theme_css
css: > run-p -s uglify_css:*
js: $ npm run uglify-js && npm run deploy
js: > js@2024.2.2 uglify-js path_to_\j1-template\packages\200_theme_js
